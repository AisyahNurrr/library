            ...
            <div class="card-body">
                <form action="{{ route('AddBook') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_buku" class="form-control" id="kode_buku" placeholder="Tambahkan kode buku" required>
                        @error('kode_buku')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul_buku" class="form-control" id="judul_buku" placeholder="Tambahkan judul buku" required>
                        @error('judul_buku')
                           <span class="text-danger">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="penulis" class="form-control" id="penulis" placeholder="Tambahkan nama penulis" required>
                        @error('penulis')
                           <span class="text-danger">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun_terbit" class="form-control" id="tahun_terbit" placeholder="Tambahkan tahun terbit" min="1000" max="9999" required>
                        @error('tahun_terbit')
                           <span class="text-danger">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_buku" class="form-control" id="jumlah_buku" placeholder="Tambahkan jumlah buku" min="1" required>
                        @error('jumlah_buku')
                           <span class="text-danger">{{ $message }}</span> 
                        @enderror
                    </div>
